    ...
    with op.batch_alter_table('sample_data', schema=None) as batch_op:
        ...
        batch_op.alter_column('prod_attributes5',
              ...
              if '_rule_matched' in sample_columns:
                     _drop_index_if_exists(batch_op, sample_indexes, 'idx_rule_brand', mysql_length={'brand': 50, '_rule_matched': 20})
                     _drop_index_if_exists(batch_op, sample_indexes, 'idx_rule_category', mysql_length={'category': 50, '_rule_matched': 20})
                     _drop_index_if_exists(batch_op, sample_indexes, 'idx_rule_matched')
                     _create_index_if_missing(batch_op, sample_indexes, 'ix_sample_data__rule_matched', ['_rule_matched'], unique=False)
